...
## 子元素分割线 `border-inline-end`

<div style="background-color: #1a1a1a; padding: 15px 25px; border-radius: 50px; display: flex; align-items: center; gap: 0; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2); color: white; font-size: 24px;width:fit-content;margin:0 auto">
  <!-- 图标 1: 旗帜 -->
  <!-- 默认拥有右边框 (border-inline-end) -->
  <div style="padding: 0 20px; cursor: pointer; border-inline-end: 1px solid rgba(255, 255, 255, 0.3)" title="Flag">🚩</div>
  <!-- 图标 2: 书签 -->
  <div style="padding: 0 20px; cursor: pointer; border-inline-end: 1px solid rgba(255, 255, 255, 0.3)" title="Bookmark">🔖</div>
  <!-- 图标 3: 心形 -->
  <div style="padding: 0 20px; cursor: pointer; border-inline-end: 1px solid rgba(255, 255, 255, 0.3)" title="Like">❤️</div>
  <!-- 图标 4: 齿轮 (最后一个) -->
  <!-- 【关键】：因为没有 :last-child 伪类，必须手动在这里添加 border-inline-end: none -->
  <div style="padding: 0 20px; cursor: pointer; border-inline-end: none" title="Settings">⚙️</div>
</div>
...
<div class="toolbar">
  <div class="icon-item" title="Flag">🚩</div>
  <div class="icon-item" title="Bookmark">🔖</div>
  <div class="icon-item" title="Like">❤️</div>
  <div class="icon-item" title="Settings">⚙️</div>
</div>
```
...
<div style="box-shadow: 2px 2px 2px 2px rgba(0, 0, 0, 0.5);line-height: 40px;width: 200px;margin: 0 auto">
	<div style="margin: 20px;outline: 1px solid #0a66c2;width: 100%;">submit</div>
</div>
<div style="box-shadow: 2px 2px 2px 2px rgba(0, 0, 0, 0.5);line-height: 40px;width: 200px;margin: 0 auto">
	<div style="margin: 20px;outline: 1px solid #0a66c2;width: stretch;">submit</div>
</div>
...
<div class="parent">
  <div class="child">submit</div>
</div>
<div class="parent">
  <div class="child stretch">submit</div>
</div>
```

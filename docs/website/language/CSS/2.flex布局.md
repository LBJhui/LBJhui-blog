...
在 flex 容器中，当一个子项的某个方向的 margin 被设置为 `auto` 时，它会自动“吃掉”该方向上所有的剩余空间。

<div style="display: flex">
  <div style="width: 15%; background-color: aliceblue">1</div>
  <div style="width: 15%; background-color: aqua">2</div>
  <div style="width: 15%; margin-right: auto; background-color: aquamarine">3</div>
  <div style="width: 15%; background-color: beige">4</div>
  <div style="width: 15%; background-color: bisque">5</div>
</div>
:::
